...
def test_main_vertex_mode():
    ...
    with patch("os.getenv") as mock_getenv, \
        ...
        # Branch 1: Vertex AI
        mock_getenv.side_effect = lambda k, d=None: "1" if k == "GOOGLE_GENAI_USE_VERTEXAI" else None
...
def test_main_developer_mode():
    ...
    with patch("os.getenv") as mock_getenv, \
        ...
        def side_effect(k, d=None):
            if k == "GEMINI_API_KEY": return "secret"
            return None
