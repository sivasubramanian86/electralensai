...
class TestQueryEndpoint:
    ...
    def test_query_returns_200(self, mock_run_async: MagicMock, client) -> None:
    ...
    @patch("api.routers.agent_router.runner.run_async")
    def test_query_response_has_answer_field(self, mock_run_async: MagicMock, client) -> None:
    ...
    def test_query_rejects_empty_question(self, client) -> None:
    ...
    def test_query_rejects_short_question(self, client) -> None:
