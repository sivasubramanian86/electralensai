...
def test_live_health() -> None:
    ...
    # But it is prefixed with /v1 in app.py? No, line 66 in app.py says
    # tags=["Live"] without prefix?
...
def test_live_ws_session_extended(mock_run_live) -> None:
...
def test_live_ws_retry_exhaustion(mock_sleep, mock_run_live) -> None:
